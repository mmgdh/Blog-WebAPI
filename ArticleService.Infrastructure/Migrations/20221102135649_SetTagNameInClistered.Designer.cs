...
namespace ArticleService.Infrastructure.Migrations
{
    ...
    [Migration("20221102135649_SetTagNameInClistered")]
    partial class SetTagNameInClistered
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArticleService.Domain.Entities.ArticleHtml", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("T_ArticleHtml", (string)null);
                });
            ...
            modelBuilder.Entity("ArticleService.Domain.Entities.ArticleTag", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("TagName"));
            ...
            modelBuilder.Entity("ArticleService.Domain.Entities.ArticleHtml", b =>
                {
                    b.HasOne("ArticleService.Domain.Entities.Article", "article")
                        .WithOne("articleHtml")
                        .HasForeignKey("ArticleService.Domain.Entities.ArticleHtml", "ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
